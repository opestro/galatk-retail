  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'products/new', name: 'admin-product-create', component: () => import('@/views/admin/ProductCreateView.vue') },
        ...
        { path: 'orders/:orderId', name: 'admin-order-detail', component: () => import('@/views/admin/OrderDetailView.vue') },
